                    ...
                    <v-row v-if="edit">
                        ...
                        >
                            ...
                            <v-text-field
                                ...
                                required
                                type="email"
                                :readonly="rol.id ? true : false"
                                density="compact"
                                variant="outlined"
                            ></v-text-field>
                            <v-text-field
                                v-show="!rol.id"
                                v-model="rol.password"
                                label="Password"
                                persistent-hint
                                required
                                type="password"
                                :readonly="rol.id  && !password_reset ? true : false"
                                density="compact"
                                variant="outlined"
                            ></v-text-field>
                            <v-text-field
                                v-show="!rol.id"
                                v-model="rol.password_confirmation"
...
export default {
    data() {
        return {
            ...
            breadcrumbs: [
                ...
                { title: 'Nuevo', disabled: false, href: '/rol/new' },
            ],
            search: '',
            itemsPerPage: 20,
            headers: [
    ...
    methods: {
        async getData() {
            ...
            axiosClient.get(`/rol/${this.$route.params.id}`, this.requestHeaders())
                .then(response => {
