        ...
        <template v-slot:content>
            ...
            >
                <template v-slot:item.actions="{ item }">
                    <v-btn size="x-small" variant="text" @click="$router.push(`/rol/${item.id}`)">Editar</v-btn>
                    <!-- <v-menu>
...
export default {
    data() {
        return {
            ...
            breadcrumbs: [
                ...
                { title: 'Roles', disabled: true, href: '/roles' },
    ...
    methods: {
        async getRoles() {
            ...
            axiosClient.get(`/rol`, this.requestHeaders())
                .then(response => {
                    _this.roles = response.data;

                    _this.roles.sort((a, b) => {
