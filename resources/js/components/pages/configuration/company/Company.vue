        ...
        <template v-slot:content>
            ...
            >
                <template v-slot:item.actions="{ item }">
                    <v-btn size="x-small" variant="text" @click="$router.push(`/module/${item.id}`)">Editar</v-btn>
                    <!-- <v-menu>
    ...
    data() {
        return {
            ...
            breadcrumbs: [
                ...
                { title: 'Módulos', disabled: true, href: '/modules' },
                { title: 'Nuevo', disabled: false, href: '/module/new' },
            ],
            search: '',
            itemsPerPage: 20,
            headers: [
                { title: 'Nombre', align: 'start', sortable: true, key: 'company_name' },
